...
This repository provides code for training federated learning models on MNIST and CIFAR-10 datasets with IPM attack setting, differential privacy, and aggregation methods.
