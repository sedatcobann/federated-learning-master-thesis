...
def process_epoch_updates(
    ...
    # This will hold flattened vectors for all clients + server
    epoch_updates = []
    # This will hold the flattened last layer parameters for all clients + server
...
def flatten_update(update):
    ...
    elif isinstance(update, dict):  # covers OrderedDict
        flat_list = []
